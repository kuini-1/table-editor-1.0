...
export default function EventSystemPage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-900">
      <TableHeader
        title={selectedTable?.name || 'Event System Table'}
        description={
          <div className="flex items-center gap-2">
            <span>Manage event system data and configurations</span>
      ...
      <div className="flex-1 overflow-hidden px-4 pb-4">
        <DataTable
          ...
          onDuplicate={(row) => {
            setSelectedRow(row as EventSystemRow);
        ...
        >
          <SheetHeader className="px-6 py-4 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-800">
            <SheetTitle className="text-indigo-600 dark:text-indigo-400 text-2xl font-bold">
              {formMode === 'add' ? 'Add Event System Entry' : 
               formMode === 'edit' ? 'Edit Event System Entry' : 
               'Duplicate Event System Entry'}
            </SheetTitle>
          </SheetHeader>
      ...
      <DeleteDialog
        ...
        itemName={selectedRow?.wszName || "this event system entry"}
      />
