...
interface ItemMixExpRow extends ItemMixExpFormData {
  id: string;
}

export default function ItemMixExpPage() {
  ...
  const [selectedRow, setSelectedRow] = useState<ItemMixExpRow | null>(null);
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <TableHeader
        title={selectedTable?.name || 'Item Mix Experience Table'}
        description="Manage item mix experience requirements"
        columns={columns}
        filters={filters}
      ...
      <ImportDialog
        ...
        tableId={tableId}
        tableName="table_item_mix_exp_data"
      />
    </div>
  );
} 