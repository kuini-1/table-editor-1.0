...
import { columns, type HlsItemRow } from './schema';

export default function HlsTablePage() {
  const searchParams = useSearchParams();
  const tableId = searchParams.get('id') || '';
  const tableName = 'table_hls_data';
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <TableHeader
        title={selectedTable?.name || 'HLS Table'}
        description="Manage HLS items and settings"
        columns={columns}
        filters={filters}
